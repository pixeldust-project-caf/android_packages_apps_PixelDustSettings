...
import com.pixeldust.settings.navigation.ViewUtils;
        ...
        if (attrs != null) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                    icon = ta.getDrawable(R.styleable.BubbleToggleView_settings_icon);
                else
                icon = AppCompatResources.getDrawable(getContext(), ta.getResourceId(R.styleable.BubbleToggleView_settings_icon, R.drawable.default_icon));
                iconWidth = ta.getDimension(R.styleable.BubbleToggleView_settings_iconWidth, iconWidth);
                iconHeight = ta.getDimension(R.styleable.BubbleToggleView_settings_iconHeight, iconHeight);
                shape = ta.getDrawable(R.styleable.BubbleToggleView_settings_shape);
                shapeColor = ta.getColor(R.styleable.BubbleToggleView_settings_shapeColor, shapeColor);
                showShapeAlways = ta.getBoolean(R.styleable.BubbleToggleView_settings_showShapeAlways, false);
                title = ta.getString(R.styleable.BubbleToggleView_settings_title);
                titleSize = ta.getDimension(R.styleable.BubbleToggleView_settings_titleSize, titleSize);
                colorActive = ta.getColor(R.styleable.BubbleToggleView_settings_colorActive, colorActive);
                titleColorActive = ta.getColor(R.styleable.BubbleToggleView_settings_titleColorActive, colorActive);
                colorInactive = ta.getColor(R.styleable.BubbleToggleView_settings_colorInactive, colorInactive);
                isActive = ta.getBoolean(R.styleable.BubbleToggleView_settings_active, false);
                animationDuration = ta.getInteger(R.styleable.BubbleToggleView_settings_duration, DEFAULT_ANIM_DURATION);
                internalPadding = (int) ta.getDimension(R.styleable.BubbleToggleView_settings_padding, internalPadding);
                titlePadding = (int) ta.getDimension(R.styleable.BubbleToggleView_settings_titlePadding, titlePadding);
            } finally {
                ta.recycle();
            }
        }
